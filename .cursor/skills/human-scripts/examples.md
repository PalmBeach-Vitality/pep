# Human Script Agent — examples

## Generic texture (not Pep)

AI:

> In today's video, we are going to delve into the pivotal role of recovery and unlock the power of better sleep. It's not just about rest. It's about giving your body the comprehensive support it needs.

Human:

> Most people treat sleep like leftover time. That's why recovery stays mediocre.
>
> Tonight I want one change from you. Protect the last hour before bed like it actually matters.

AI:

> Furthermore, this peptide has garnered attention for its seamless integration into existing wellness routines.

Human:

> People ask if this fits a normal week. If your nights and training are already consistent, yes. If nothing else in your routine is stable, start there first.

## Pep 30s — unique hook, locked close
...
> Don't scroll. I'm Palm Beach Pep, walking this boardwalk.

Full 20 × 30s read list: `marketing/n8n-pep-20-vo-review.md`.
60s review-only: `marketing/n8n-pep-60s-human-vo.md`.
