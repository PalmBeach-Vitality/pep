...
> **REFERENCE SNAPSHOT** copied 2026-08-13 from the other agent’s branch `cursor/idea-to-video-nodes-0b73` (PR #11).  
> Source agent: [custom vid_gen workflow](https://cursor.com/agents/bc-65890aad-1acd-4e10-a29d-f0cbd4f00b73).  
> This is **not** `vid_gen_palm_beach_pep`. Do not rename or merge these nodes onto the Pep OmniHuman canvas.  
> Later live-path updates (hero 16:9 / `manual_still_url`) are in `marketing/references/n8n-custom-vid-gen-from-other-agent.md`.
