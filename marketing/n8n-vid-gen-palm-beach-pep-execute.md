...
| 9 | `prep_day_variants` | Build 4 beat briefs + VO splits |
...
| `if_complaince` | **true** → `prep_day_variants`; **false** → stop |

---

## Phase C — Locked Pep still (exact names first)
1. `prep_day_variants` — paste `marketing/n8n-pep-prep-beats.js`  
...
| `marketing/n8n-pep-prep-beats.js` | Code for `prep_day_variants` |
