...
SCENES_DATA = [
    dict(
        ...
        hook="You can still smell the salt in these boards. I'm Palm Beach Pep.",
        science="BPC-157 is a short gut-protein fragment. Labs follow it as a local lining and tendon repair signal.",
    ...
    dict(
        ...
        hook="Lane's empty. Just me on the turf. I'm Palm Beach Pep.",
        science="TB-500 is a thymosin beta-4 fragment. Papers follow it when cells need a track into a repair zone.",
    ...
    dict(
        ...
        hook="Petals keep landing on the hat. I'm Palm Beach Pep.",
        science="GHK-Cu is three amino acids holding copper. That's the complex papers watch for collagen in skin.",
    ...
    dict(
        ...
        hook="Steady on this path. I'm Palm Beach Pep.",
        science="Semaglutide copies GLP-1, the meal hormone. After you eat, it helps insulin when sugar is high and slows emptying.",
    ...
    dict(
        ...
        angle="low-angle", direction="front",
        hook="That water's trying to shout over me. I'm Palm Beach Pep.",
        science="Tirzepatide knocks two meal-hormone receptors, GIP and GLP-1. Labs watch insulin and appetite on both.",
    ...
    dict(
        ...
        hook="Stay on the dirt. The drop's real. I'm Palm Beach Pep.",
    ...
    dict(
        ...
        angle="eye-level", direction="front",
        hook="Morning's quiet. Rubber chips under the sneakers. I'm Palm Beach Pep.",
        science="AOD-9604 is a tail-piece of growth hormone. Papers follow the fat-breakdown note from that fragment.",
    ...
    dict(
        ...
        angle="eye-level", direction="slight-left",
        hook="Wildflowers up to the knees out here. I'm Palm Beach Pep.",
    ...
    dict(
        ...
        angle="eye-level", direction="slight-right",
        hook="Water hasn't moved once. I'm Palm Beach Pep.",
        science="Selank is a tuftsin analog. Labs watch the brain's GABA calm-down conversation. Quiet on purpose.",
    ...
    dict(
        ...
        angle="eye-level", direction="front",
        hook="Daylight's bouncing off the racks. I'm Palm Beach Pep.",
    ...
    dict(
        ...
        hook="Quiet in the kettlebell aisle. I'm Palm Beach Pep.",
    ...
    dict(
        ...
        angle="low-angle", direction="front",
        hook="This sandstone's still holding heat. I'm Palm Beach Pep.",
        science="Tesamorelin is a stabilized GHRH analog. Pituitary asks for GH, then IGF-1. Papers have watched body-composition markers.",
    ...
    dict(
        ...
        angle="eye-level", direction="slight-left",
        hook="Glass is fogged and the ferns are dripping. I'm Palm Beach Pep.",
    ...
    dict(
        ...
        hook="Blue lights, empty bikes, one still on. I'm Palm Beach Pep.",
    ...
    dict(
        ...
        angle="low-angle", direction="front",
        hook="Leave the ropes. I'm Palm Beach Pep.",
        science="BPC-157 is a local repair signal. TB-500 is studied for helping cells migrate. Two jobs.",
    ...
    dict(
        ...
        angle="eye-level", direction="slight-right",
        hook="Lanterns on the planks tonight. I'm Palm Beach Pep.",
    ...
    dict(
        ...
        angle="eye-level", direction="front",
        hook="Brick loft. Medicine balls on the wall. I'm Palm Beach Pep.",
    ...
    dict(
        ...
        angle="low-angle", direction="oblique right",
        hook="Assault bike stays. I'm Palm Beach Pep.",
    ...
    dict(
        ...
        angle="low-angle", direction="front",
        hook="Canvas corner. Sneakers planted. I'm Palm Beach Pep.",
    ...
    dict(
        ...
        angle="eye-level", direction="front",
        hook="Mist hasn't burned off the lake. I'm Palm Beach Pep.",
