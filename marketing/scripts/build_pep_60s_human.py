...
SCIENCE_60 = {
    "PEP-001": (
        ...
        "Labs study it as a local repair signal around gut lining, tendon, and new blood vessels. "
        "Nitric-oxide and growth-factor talk in that neighborhood. "
        "Papers follow cytoprotection after a local insult. "
        "If you keep one picture, keep neighborhood repair. I'm walking these planks because the story is local. "
        "I'm still on these boards."
    ),
    "PEP-002": (
        ...
        "It's a cytoskeleton story. Actin remodeling is why movement papers keep coming back. "
        "Cells need a track to crawl on. I'm jogging this turf because the story is motion. "
        "I'm still on this lane."
    ),
    "PEP-003": (
        ...
        "Measured GHK falls with age, which is why remodeling papers watch it. "
        "Copper delivery. Collagen talk. Petals can fall. The copper story stays."
    ),
    "PEP-004": (
        "Semaglutide is a GLP-1 receptor agonist, a long-acting copy of the meal hormone GLP-1. "
        "After you eat, GLP-1 tells the pancreas to release insulin when glucose is high, eases extra liver sugar, "
        ...
        "One receptor. Keep it that simple."
    ),
    "PEP-005": (
        "Tirzepatide talks to two incretin receptors: GIP and GLP-1. "
        "Together they're researched for insulin when glucose is high, for appetite, and for how fat tissue handles energy. "
        "Two meal-hormone knocks, one molecule. Dual incretin design. Two receptors, one coordinated meal talk. "
        "That's the map labs follow. GIP plus GLP-1. Named receptors, named jobs. "
        "The water can crash. The mechanism stays two knocks. Hear both receptor names."
    ),
    "PEP-006": (
        "Retatrutide talks to three receptors: GIP, GLP-1, and glucagon. "
        "GIP and GLP-1 are meal hormones for insulin when glucose is high, and for appetite. "
        ...
        "Three receptors. Count them once."
    ),
    "PEP-007": (
        ...
        "Tail of HGH. Quieter growth axis. Labs follow lipolysis in fat-cell models. "
        "One fragment. One note. That's the fragment on this park."
    ),
    "PEP-008": (
        ...
        "BDNF. NGF. Cognition models. Lights-on research for the mind. "
        "Wildflowers can wait. The learning-signal story is why this clip exists. "
        "The meadow can wait for the signal."
    ),
    "PEP-009": (
        ...
        "Water's still for a reason. This is the quiet peptide on this deck now."
    ),
    "PEP-010": (
        ...
        "Short pulse. Then the liver hears IGF-1."
    ),
    "PEP-011": (
        "CJC with no DAC is a GHRH analog. It binds pituitary receptors and asks for a growth-hormone pulse. "
        "With no drug-affinity complex, it doesn't hang around for days: a knock, a rise, then back toward the body's rhythm. "
        "GH then tells the liver to talk in IGF-1. Same GHRH family as the other releasing analogs. "
        "Short pulse. Then clear. That's the shape labs watch. "
        "No DAC means it doesn't camp out."
    ),
    "PEP-012": (
        ...
        "Stabilized GHRH. Warm sandstone. Same ask every step. "
        "Pituitary. GH. IGF-1. Markers. In that order. Warm rock holds."
    ),
    "PEP-013": (
        ...
        "Three letters. Melanocortin calm-down only. That's the half they measure. "
        "Keep the tanning hormone out of this sentence. Ferns dripping."
    ),
    "PEP-014": (
        ...
        "Battery shuttle. Redox coin cells spend to keep themselves. "
        "Cadence is a joke. The shuttle is the point. Electrons move. ATP gets made. Stay on it."
    ),
    "PEP-015": (
        ...
        "Gastric fragment plus thymosin fragment. Two mechanisms. One shelf. "
        "Say them in that order. Local restore. Crawl path. Two jobs."
    ),
    "PEP-016": (
        ...
        "Lantern light is just the set. Keep copper last so collagen has somewhere to land."
    ),
    "PEP-017": (
        ...
        "AMPK on, glucose handled more steadily. Encoded in mtDNA. "
        "The message still comes from the mitochondria, not the nucleus. Brick loft. Medicine balls stay."
    ),
    "PEP-018": (
        ...
        "Together they're studied for a more natural-shaped pulse, then IGF-1. "
        "GHRH plus ghrelin path. Two knocks, one pituitary. "
        "CJC asks. Ipamorelin knocks. Pulse, then IGF-1. Rubber floor stays."
    ),
    "PEP-019": (
        ...
        "The wrench is for the wall of the mitochondrion. Keep the wrench on that wall."
    ),
    "PEP-020": (
        ...
        "It doesn't stay around like a DAC analog. Researchers watch a rise, then IGF-1 downstream. "
        "Same GHRH family as the other releasing analogs, just the original short fragment. "
        "Ask. Pulse. Clear. Original fragment. That's sermorelin, said once on this dock."
    ),
}
...
BEAT_60 = {
    "PEP-001": "Researchers keep coming back to lining and tendon after a local insult. That's the paper trail. Lining. Tendon. New vessels. Same neighborhood. Local story.",
    "PEP-002": "If the cell can't crawl, the repair zone stays empty. Actin is the track. I'm still jogging. Scaffold. Crawl. Motion first.",
    "PEP-003": "Collagen talk is the headline. Copper is the delivery. Age drops measured GHK, so papers keep watching that drop. Three letters, one ion. Stay.",
    "PEP-004": "Native GLP-1 is gone in minutes. This analog stays. Insulin when sugar is high. That's the meal talk. One receptor. GLP-1.",
    "PEP-005": "Name the receptors. GIP. GLP-1. One molecule knocks both. Two knocks. One walk along this crashing water. Stay with the water.",
    "PEP-006": "Dual incretin stops at two. This one adds glucagon for energy spend. Three levers. One analog. Keep hiking.",
    "PEP-007": "Labs follow lipolysis in fat-cell models. Fragment of the tail. The rest of HGH stays off this page. One note. Morning miles. That's AOD. Keep jogging.",
    "PEP-008": "Neurotrophins first. BDNF. NGF. Cognition models. That's Semax without caffeine in the sentence. Keep moving through the meadow. Lights on. Learning signal.",
    "PEP-009": "Mood-model endpoints sit next to immune markers because tuftsin started this analog. Quiet on purpose. GABA first. Deck still. Easy morning on this water. Listen once.",
    "PEP-010": "Older GHRPs made more noise on cortisol. This knock is researched as the quieter GH ask. Short pulse. Gym daylight. Walk it.",
    "PEP-011": "No DAC means a short visit. Knock. Rise. Back toward rhythm. Iron stays in the aisle.",
    "PEP-012": "Body-composition markers sit downstream of IGF-1. Follow that order and the mesa hike makes sense. Pituitary first. Then GH. Same ask every step. Keep hiking.",
    "PEP-013": "Pigment is the other half of alpha-MSH. This clip only carries the calm-inflammation tip. Three letters. Gut and skin models. That's KPV. Ferns stay wet.",
    "PEP-014": "Sirtuins listen. PARP listens. The shuttle still has to move electrons or ATP does not get made. Bike stays on. Electrons first.",
    "PEP-015": "Say gastric fragment, then thymosin fragment. Restore, then crawl. Two stories. I will not mash them. Ropes can wait on the turf. Two jobs.",
    "PEP-016": "Protect, crawl, remodel. That order is the stack. Copper last so collagen has a job at the end. Lanterns stay. Three jobs.",
    "PEP-017": "Nucleus DNA doesn't write this one. Mitochondria do. AMPK is the gauge. Fuel message. Keep jogging this loft. AMPK on. Mito-peptide.",
    "PEP-018": "GHRH analog plus ghrelin agonist. Two knocks, one gland. Natural-shaped pulse is the reason they sit together. Bike stays. Two knocks.",
    "PEP-019": "Cardiolipin is the fat in the wall. Messy wall, leaky electrons. This tetrapeptide is researched as the tidy-up. Keep shuffling. Canvas holds. Less leak. Stay planted.",
    "PEP-020": "Twenty-nine amino acids. Original GHRH fragment. Ask the pituitary. Watch the rise. Then IGF-1. Dock done. Mist holds. Ask once. Original fragment. Keep jogging.",
}
