...
{{ JSON.stringify({
  ...
  prompt: [
    ...
    'COLOR SYSTEM TODAY (must dominate lighting, LEDs, rim light, and grade): ' + String($('Prep_day_variant').item.json.daily_color_scheme || 'electric cyan-blue on dark lab') + '.',
    'Lighting: follow COLOR SYSTEM TODAY for rim light and instrument LEDs; soft volumetric haze; ultra-clean glass refraction; subtle LED pulse. Do not reuse yesterday’s color grade.',
