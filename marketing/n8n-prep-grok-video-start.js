...
var VIAL_LABEL_LOCK =
  'VIAL LABEL LOCK (MANDATORY): If a vial is visible, keep or set the vial label to peptide name + 10ml only. ' +
  'FORBIDDEN on the vial: mg, mg/ml, mg/mL, mcg, IU, concentration, dosage. Never add 1000mg or 10mg/mL.';
